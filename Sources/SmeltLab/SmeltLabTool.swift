...
func parseOptionalPositiveIntArg(_ name: String, from args: [String]) throws -> Int? {
...
func formatExact(_ value: Float) -> String {
...
private func usage(exitCode: Int32 = 2) -> Never {
    fputs(
        """
        Usage:
          smelt lab probe tokenize --package <pkg> (--prompt <text> | --prompt-file <path>) [--prepend-bos auto|always|never]
          smelt lab probe text-runtime-stats --package <pkg> [--batch-capacity N] [--context-capacity N]
          smelt lab probe bench-verify-argmax --package <pkg> --ids <csv> [--batches 1,2,4] [--warmup N] [--iterations N]
          smelt lab probe check-qwen35-vision --module <model.module.json> --checkpoint <hf-dir>
          smelt lab probe run-qwen35-vision (--component <agentcomponent> | --module <model.module.json> --checkpoint <hf-dir> [--shader-dir <dir>]) [--image <file> | --temporal N --height N --width N] [--packed-segments N] [--gemm mps|reference-metal] [--attention reference|mps-staged] [--reference-f32 <file>] [--output-f32 <file>] [--cost-json <file>] [--profile-cost | --profile-cost-iterations N] [--cost-calibration-json <file>]
          smelt lab probe compare-rows --package <pkg> [--slot <n> | --prefill-slot <n> --decode-slot <n>] --ids <csv> --row-width <n> --prefill-dispatch <n> --decode-dispatch <n> [--decode-row-index base|last|N]
          smelt lab probe compare-final-slot --package <pkg> [--context-limit N] [--slot <n> | --prefill-slot <n> --decode-slot <n>] --ids <csv> --count <n>
          smelt lab probe generate-ids --package <pkg> [--context-limit N] --ids <csv> [--prefix-mode prefill|decode] [--max-tokens N] [--top-k N]
          smelt lab probe compare-label --package <pkg> [--context-limit N] --ids <csv> --label <name> [--occurrence first|last|N]
          smelt lab probe analyze-rmsnorm-add --package <pkg> --ids <csv> --prefill-norm-dispatch <n> --prefill-add-dispatch <n> --decode-dispatch <n> [--prefill-row-index base|last|N] [--dim <n>] [--eps <f>]
          smelt lab probe list-dispatches --package <pkg> [--mode decode|prefill] [--contains <substring>]
          smelt lab probe bench-dispatch --package <pkg> --ids <csv> --dispatch <n> [--warmup <n>] [--iterations <n>]
          smelt lab probe bench-pipeline --package <pkg> --ids <csv> --contains <substring> [--warmup <n>] [--iterations <n>]
          smelt lab probe compare-decode-plans --package <pkg> --ids <csv> --candidate-table <path> [--baseline-table <path>] [--baseline-id <id>] [--candidate-id <id>] [--warmup <n>] [--iterations <n>] [--output <json>]
          smelt lab probe inspect-label --package <pkg> [--context-limit N] --ids <csv> --label <name> [--mode prefill|decode|both] [--occurrence first|last|N] [--prefill-count N] [--buffer-index N] [--row-index base|last|N] [--force-dtype fp16|fp32|int32] [--value-offset <n>] [--values <n>]
          smelt lab probe inspect-dispatch --package <pkg> [--context-limit N] --ids <csv> --mode prefill|decode --dispatch <n> [--prefill-count N] [--buffer-index N] [--row-index base|last|N] [--force-dtype fp16|fp32|int32] [--value-offset <n>] [--values <n>]
          smelt lab probe compare-label-binding --package <pkg> [--context-limit N] --ids <csv> --label <name> --buffer-index <n> [--occurrence first|last|N] [--prefill-row-index base|last|N] [--decode-row-index base|last|N] [--force-dtype fp16|fp32|int32] [--value-offset <n>] [--count <n>]

        Example:
          smelt lab probe compare-rows --package <pkg> --ids 2,818,5279,529,7001,563 --slot 22 --row-width 512 --prefill-dispatch 3392 --decode-dispatch 133
        """,
        stderr
    )
    exit(exitCode)
...
public func runSmeltLabProbe(arguments args: [String]) {
    do {
